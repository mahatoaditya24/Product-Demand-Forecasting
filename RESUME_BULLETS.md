...
> **Enterprise Supply Chain & Vendor Intelligence System** | *Python, FastAPI, Scikit-Learn, XGBoost, Docker, Streamlit*  
...
> - Containerized the serving infrastructure using **Docker** and deployed a high-performance **FastAPI REST microservice** (`/docs`) alongside an interactive **Streamlit web portal**.

---

### Option B: Concise 4-Pointer Version (Fits on 1–2 Lines per Bullet)
> **Enterprise Supply Chain & Vendor Intelligence System** | *Python, FastAPI, Scikit-Learn, XGBoost, Streamlit, Docker*  
...
> - Deployed a **FastAPI REST microservice** and an interactive **Streamlit web portal** with automated CI/CD and **21 unit tests** on GitHub Actions.
...
- **API Serving & Microservices:** `FastAPI`, `Uvicorn`, `Pydantic Schema Validation`, `Swagger UI / OpenAPI`, `Batch Prediction Endpoints`, `REST Webhooks`
- **Web UI & Visualization:** `Streamlit`, `Plotly`, `Matplotlib`, `Seaborn`, `Interactive CSV Uploads`
- **DevOps, Testing & CI/CD:** `Docker`, `Docker Compose`, `GitHub Actions (CI/CD)`, `PyTest (21 Unit Tests)`, `Git`
...
### Q3: "Why did you build both FastAPI and Streamlit?"
> **Answer:**
> *"Streamlit provides an intuitive, interactive UI for business operators and finance analysts to test single scenarios and upload bulk CSV batches. However, in enterprise environments, downstream ERP or warehouse management systems need programmatic machine-to-machine integrations. By developing a FastAPI REST microservice with Pydantic request validation and Swagger documentation, the platform supports both human exploration and automated system integration."*
